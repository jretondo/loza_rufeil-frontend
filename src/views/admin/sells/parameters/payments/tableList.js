...
const PaymentsMethodsTable = ({
  ...
  const tableTitles = hasAccountingModule
    ? ['Número de Punto de Venta', 'Cuenta Asdociada', 'Visible', '']
    : ['Número de Punto de Venta', 'Visible', ''];
            ...
            return (
              <tr key={payment.id}>
                <td
                  ...
                  onDoubleClick={
                    !payment.change ? () => handleClick(key) : () => {}
                  }
                >
                  {!payment.change ? (
                    payment.number
                    ...
                    <Input
                      type="number"
                      value={paymentsArray[key].number}
                      onChange={(e) => {
                ...
                {hasAccountingModule && (
                  <td className="text-center">
                    <InputSearch
                      ...
                      itemSelected={
                        paymentsArray[key]
                          ? paymentsArray[key].AccountChart
                          : false
                      }
                      title={''}
